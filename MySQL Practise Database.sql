...
--Find forename and surname name of all employees
...
SELECT client.client_name AS Branch_and_Client_Names, client.branch_id AS Branch_ID
FROM client
UNION
SELECT branch_supplier.supplier_name, branch_supplier.branch_id
FROM branch_supplier;

--Find a list of all spent or earned by the company
SELECT salary
FROM employee
UNION
SELECT total_sales
